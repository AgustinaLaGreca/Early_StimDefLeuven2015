function Freq=EvalFrequencyStepperBPN(figh, Prefix, P);
...
elseif any(P.StartFreq<P.LowFreq),
    GUImessage(figh, {'Start frequency not in noise spectrum'...
        },'error', [Prefix 'StartFreq']);
elseif any(P.EndFreq>P.HighFreq),
    GUImessage(figh, {'End frequency not in noise spectrum'...
        },'error', [Prefix 'EndFreq']);
