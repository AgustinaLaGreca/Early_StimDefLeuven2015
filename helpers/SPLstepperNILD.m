 function Levels=SPLstepperNILD(T, EXP, Prefix, CmpName);
% SPLstepperNILD - generic panel for stepped SPL and DAchannel in stimulus GUIs.
%   S=SPLstepperNILD(Title, EXP) returns a GUIpanel M named 'Levels' allowing the 
...
%&&&&&&&&
ConstantSPL = ParamQuery([Prefix 'ConstantSPL'], 'constant ear:', '-10.5 -10.5', {'dB SPL' 'dB/Hz'}, ...
...
StartSPL = ParamQuery([Prefix 'StartSPL'], 'start:', '-10.5 -10.5', 'dB', ...
...
Levels = add(Levels,AltLevel,'nextto',[10 10]);
