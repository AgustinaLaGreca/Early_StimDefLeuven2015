function ReportSummaryBPN(figh, P);
% 
% Note: This function is a form modified of ReportSummary.
% 
% ReportSummaryBPN - compute total play time and report it to Summary panel 
...
% 
% 
%     ReportSummaryBPN() was created to display 'Full Band Spectrum' during the
%     first iteration. ReportSummary() was working with numbers.
%     It was not possible to include a string during the first instance. So
%     ReportSummaryBPN() was created.
% 
%     In BPN, at the first instance, a fullband noise is generated. It was
%     not possible to display 'Full Band Noise' using ReportSummary. Hence
%     ReportSummaryBPN was created.
% 
