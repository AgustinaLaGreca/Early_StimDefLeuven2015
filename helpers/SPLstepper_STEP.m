function Levels=SPLstepper_STEP(T, EXP, Prefix, CmpName,Flag, Tooltip);
...
[Prefix, ~, Tooltip] = arginDefaults('Prefix/CmpName/Tooltip', '', 'Carrier','');
...
StepFactor = ParamQuery([Prefix 'StepFactor'], 'factor:', '-10 -10', 'dB SPL', ...
    'rreal', ['Step Factor: change in dB of the STEP can be positive or negative.' Tooltip PairStr], Nchan);
...
Levels = add(Levels,StepFactor,nextto(EndSPL),[10 0]);
