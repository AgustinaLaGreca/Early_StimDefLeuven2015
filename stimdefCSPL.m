...
Params = add(Params, AmpRef, nextto(summ), [10 0]);
Params = add(Params, SPLsweep, below(AmpRef), [0 6]);
Params = add(Params, Clicks, below(SPLsweep), [0 6]);
Params = add(Params, freqPanel, nextto(AmpRef), [10 0]);
Params = add(Params, Dur, nextto(SPLsweep) ,[10 0]);
Params = add(Params, Pres, nextto(Dur) ,[5 0]);
Params = add(Params, PlayTime, below(Dur) , [0 38]);
