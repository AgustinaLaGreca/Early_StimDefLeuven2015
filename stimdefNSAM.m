...
% stimdefNSAM - definition of stimulus and GUI for NSAM stimulus paradigm
%    P=stimdefNSAM(EXP) returns the definition for the NSAM (______________
%    _____) stimulus paradigm. The definition P is a GUIpiece that 
...
%    side, etc.
%
%    See also stimGUI, stimDefDir, Experiment, makestimNSAM.
...
Params = add(Params, PlayTime(), below(Pres) , [0 10]);
