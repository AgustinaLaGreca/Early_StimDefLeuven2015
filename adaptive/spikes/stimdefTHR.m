...
Rec0SR = ActionButton('REC_SR', 'REC: SR', 'REC: SR', 'Start the recording of the threshold curve with a custom Spike Rate', @(Src,Ev,LR)THRstart([],-1), 'BackgroundColor', [0.65 0.75 0.7]);
