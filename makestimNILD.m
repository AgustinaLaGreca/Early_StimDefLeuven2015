...
% parameter etc
P = sortConditions(P, 'SPL', 'Intensity', P.SPLUnit , 'Linear');

% Levels and active channels (must be called *after* adding the baseline waveforms)
[mxSPL P.Attenuation] = maxSPL(P.Waveform, P.Experiment);
okay = CheckSPL(figh, P.SPL, mxSPL, [], 'MaxSPL', {'StartSPL' 'EndSPL' 'ConstantSPL'});
if ~okay, return; end
